...
console.info('Радиус вписаный в окружности треугольника = ', radius_vpis_triugolnik);

sideC_Pryamougl_Treugl = Math.sqrt(Math.pow(sideA, 2) + Math.pow(sideB, 2));
...
var userElMail;
var curDateYyyyMmDd;
var arrayUsersLastName;
var poUmolchaniy;
var value_htmlElementBorderTopRight;
...
console.info(15 / 0); // Infinity - здесь покольку деление на 0 то получается бесканечно большое число, которое выходит за границы диапазона памяти js
